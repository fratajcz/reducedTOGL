...
from . import coord_transforms as coord_transforms
...
class TopologyLayer(torch.nn.Module):
    ...
    def compute_persistence(self, x, edge_index, batch, return_filtration=False):
        ...
        if self.fake:
            return self.fake_persistence_computation(
    ...
    def fake_persistence_computation(self, filtered_v_, edge_index, vertex_slices, edge_slices, batch):
